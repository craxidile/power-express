...
const ActivityGrid = (props: PropsWithChildren<ActivityGridProps>) => {
  ...
  return (
    <ul className="lg:gap-x-12 gap-y-16 lg:gap-y-20 grid grid-cols-1 lg:grid-cols-3">
      <li>
        <ActivityBox locale={locale} image={p('mock/front/section-activities/mock-activity-01.jpg')}
      ...
      <li>
        <ActivityBox locale={locale} image={p('mock/front/section-activities/mock-activity-02.jpg')}
      ...
      <li>
        <ActivityBox locale={locale} image={p('mock/front/section-activities/mock-activity-03.jpg')}
