  ...
  return (
    <ul className="gap-x-0 lg:gap-x-12 gap-y-20 grid grid-cols-1 lg:grid-cols-3">
      <li>
        <ProjectBox
          locale={locale}
          image={p('mock/front/section-projects/mock-project-01.jpg')}
          title="โครงการโซลาร์ PPA โรงงานเหล็ก"
      ...
      <li>
        <ProjectBox
          locale={locale}
          image={p('mock/front/section-projects/mock-project-02.jpg')}
      ...
      <li>
        <ProjectBox
          locale={locale}
          image={p('mock/front/section-projects/mock-project-03.jpg')}
      ...
      <li>
        <ProjectBox
          locale={locale}
          image={p('mock/front/section-projects/mock-project-04.jpg')}
