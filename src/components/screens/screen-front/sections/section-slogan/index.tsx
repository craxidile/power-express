...
const SectionSlogan = () => {
  ...
  return (
    <section
      className="relative h-screen min-h-svh lg:min-h-[720px] bg-gray-100 flex flex-col justify-start items-stretch transition-all"
      style={{
        background: `#ccc url(${p('mock/front/section-slogan/bg.jpg')}) no-repeat center/cover`,
      }}
    >
