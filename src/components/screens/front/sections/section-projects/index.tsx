    ...
    <section className="py-20 flex flex-col justify-start items-stretch">
      <SafeArea>
        <div className="gap-y-20 flex flex-col justify-start items-stretch">
          ...
          <Link to="/">
            <div className="gap-x-4 py-4 px-6 flex flex-row justify-center items-center border border-gray-medium">
              <span className="text-xl font-medium">ดูโครงการทั้งหมด (14)</span>
