          ...
          <div className="gap-y-16 flex flex-col justify-start items-stretch">
            <div className="gap-y-12 lg:gap-y-16 flex flex-col justify-start items-stretch">
              ...
              <div
                className="h-[644px]"
                style={{
                  background: `url(${p('mock/activity/mock-banner.jpg')}) no-repeat center/cover`,
                }}
              ></div>
            </div>
            <div className="gap-y-16 lg:gap-y-0 lg:gap-x-16 flex flex-col lg:flex-row justify-start items-start">
              <div className="flex-1 flex flex-col justify-start items-stretch">
                <p className="text-gray-content text-base lg:text-lg">
                  ...
                  โครงการระบบผลิตไฟฟ้าพลังงานแสงอาทิตย์ร่วมกับ บริษัท พี.เอส.พี.
                  สเปเชียลตี้ส์ จำกัด (มหาชน) หรือ PSP
                  ผู้นำในกลุ่มอุตสาหกรรมในตลาดหลักทรัพย์แห่งประเทศไทย
                  โดยความร่วมมือในครั้งนี้ PSP ได้มอบความไว้วางใจเลือก Power
                  Express ให้เป็นผู้ดำเนินการโซลูชันพลังงานสะอาดอย่างครบวงจร
                  เพื่อยกระดับประสิทธิภาพการใช้พลังงานในระดับอุตสาหกรรม
                  <br />
                  <br />
                  โครงการนี้เป็นหนึ่งในโครงการเชิงกลยุทธ์ที่สำคัญในพอร์ตโฟลิโอของ
                  Power Express ซึ่งมีกำลังการผลิตติดตั้งรวม [ระบุตัวเลข] kWp
                  โดยจะช่วยลดต้นทุนพลังงานและสร้างผลกำไร (Profit)
                  ให้แก่พันธมิตรได้ทันทีภายใต้โมเดล Private PPA (Zero
                  Investment) ด้วยทุนจดทะเบียน 40 ล้านบาท และประสบการณ์กว่า 17
                  ปี เรายังคงมุ่งเน้นการส่งมอบมาตรฐานวิศวกรรมที่ยอดเยี่ยม
                ...
                <ul className="gap-y-6 flex flex-col justify-start items-stretch">
                  <li>
                    <MiniActivityBox
                      locale={locale}
                      image={p(
                        'mock/front/section-activities/mock-activity-01.jpg'
                      )}
                      tag="News"
                      publishedAt={new Date()}
                  ...
                  <li>
                    <MiniActivityBox
                      locale={locale}
                      image={p(
                        'mock/front/section-activities/mock-activity-02.jpg'
                      )}
                      tag="Sustainability"
                      publishedAt={new Date()}
                  ...
                  <li>
                    <MiniActivityBox
                      locale={locale}
                      image={p(
                        'mock/front/section-activities/mock-activity-03.jpg'
                      )}
                      tag="Event"
                      publishedAt={new Date()}
