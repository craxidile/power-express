    ...
    <div className="py-20 flex flex-col justify-start items-stretch">
      <SectionTwoCols title={title} colEnd={colEnd}>
        <p className="text-gray-content text-base lg:text-lg">
          ...
          พันธกิจของเราขับเคลื่อนด้วยความมุ่งมั่นที่จะสร้างผลกระทบเชิงบวกใน 3
          มิติสำคัญ ได้แก่ ผลกำไร (Profit), สิ่งแวดล้อม (Planet) และผู้คน
          (People)
          <br />
          <br />
          เราคือพันธมิตรผู้ให้บริการโซลูชันพลังงานแสงอาทิตย์สำหรับภาคธุรกิจและอุตสาหกรรม
          (C&I) อย่างเต็มรูปแบบ (Full Support)
          โดยมีความเชี่ยวชาญพิเศษด้านสัญญาซื้อขายไฟฟ้าภาคเอกชน (Private PPA)
          ที่ช่วยให้คุณ "ประหยัดค่าใช้จ่ายได้ทันที" ภายใต้โมเดล "ลงทุน 0 บาท"
          ด้วยทุนจดทะเบียน 40 ล้านบาท และประสบการณ์ในอุตสาหกรรมกว่า 17 ปี
          เราดูแลครบวงจรตั้งแต่การจัดหาเงินทุน การออกแบบวิศวกรรม
